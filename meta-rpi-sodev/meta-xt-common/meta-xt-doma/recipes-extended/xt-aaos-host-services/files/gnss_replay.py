...
#
# MODIFIED from the AOSP original (Apache-2.0 section 4(b) notice):
#   - the UNIX socket is opened SOCK_STREAM instead of SOCK_SEQPACKET. The AAOS
#     guest reaches this agent through a qemu virtconsole chardev
#     (server=on,wait=off in doma.cfg), which is a stream socket; SOCK_SEQPACKET
#     fails to connect against it.
