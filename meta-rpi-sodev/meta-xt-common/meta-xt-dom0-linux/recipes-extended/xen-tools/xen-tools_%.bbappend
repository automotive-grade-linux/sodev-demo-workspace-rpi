...
#
# The build resolves xen-tools to the STOCK meta-virtualization xen-tools_4.21.bb
# (PV "4.21+stable", SRCREV 1c72306b, branch stable-4.21), selected via
# PREFERRED_VERSION_xen-tools = "4.21+stable" in rpi5-sodev.yaml. The toolstack
# patch series is carried by the sibling xen-tools_4.21.bbappend in this layer
...
# version is selected (the stock _4.21 recipe today, or a _git fork if the pin
# were changed). Two base RDEPENDS break the dom0-thin THIN
...
# to the 4.21 recipe. The python tooling (pygrub etc.) is not used by the
